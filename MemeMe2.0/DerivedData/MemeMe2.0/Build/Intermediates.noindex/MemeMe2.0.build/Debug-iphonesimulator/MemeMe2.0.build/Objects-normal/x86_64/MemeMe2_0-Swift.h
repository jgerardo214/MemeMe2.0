...
#ifndef MEMEME2_0_SWIFT_H
#define MEMEME2_0_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MemeMe2_0",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9MemeMe2_018CollectionViewCell")
@interface CollectionViewCell : UICollectionViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified SentMemeCollectionImage;
...
SWIFT_CLASS("_TtC9MemeMe2_020DetailViewController")
...
SWIFT_CLASS("_TtC9MemeMe2_024MemeEditorViewController")
@interface MemeEditorViewController : UIViewController <UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate>
...
@property (nonatomic, weak) IBOutlet UIToolbar * _Null_unspecified navigationBar;
...
- (IBAction)imageSelected:(id _Nonnull)sender;
...
- (IBAction)cancelMeme:(id _Nonnull)sender;
- (IBAction)pickImageCamera:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9MemeMe2_013SceneDelegate")
...
SWIFT_CLASS("_TtC9MemeMe2_013TableViewCell")
